    ...
    if (!existingEntry?.length) {
      const entries = [
        ...
        },
        {
          ...
          date: new Date().toISOString().split('T')[0],
          type: 'changed',
          message: 'Optimized authentication flow notifications'
        }
      ];

      console.log('📝 Creating new entries:', entries);
      ...
      console.log(`✅ Successfully added changelog entries for version ${version}`);
    } else {
