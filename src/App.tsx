...
//       return;
//     }
//     // Otherwise, continue with your normal flow.
//     // You might decide based on payment status or other conditions here.
//     if (user) {
//       onNavigateToDashboard();
//     } else {
//       toast("You can now access the dashboard");
//     }
...
//           onNavigateToDashboard={handleProceed} 
//         />
//       </header>
...
//           ) : (
//             <h2 className="text-3xl font-bold text-center mb-12">
//               {/* {user ? `${t("eligibility.title")}` : "Eligibility Checker"} */}
//               {t("eligibility.title")}
//             </h2>
//           )}
