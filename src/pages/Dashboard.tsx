    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
         <div className="bg-white/80 backdrop-blur-glass rounded-2xl shadow-glass p-6 sm:p-8 animate-fade-in">
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-primary-600 to-primary-400 bg-clip-text text-transparent mb-6 sm:mb-10">{t("dashboard.title")}</h1>  
          <div>
    ...
    <div className="relative w-full max-w-md overflow-hidden bg-white rounded-2xl shadow-2xl">
      ...
      <div className="flex flex-col items-center px-8 pt-10 pb-8 text-center">
        ...
        <p className="mb-2 text-lg font-medium text-gray-500">
          {t("dashboard.payment.waiting")}
        </p>

        <h3 className="mb-4 text-2xl font-bold text-gray-900">
          {t("dashboard.payment.success")}
        </h3>

        <p className="mb-8 text-gray-600 text-lg">
          {t("dashboard.payment.creating")}
        </p>

        <div className="w-full p-5 mb-8 bg-gray-50 rounded-xl border border-gray-100">
          <div className="flex justify-between items-center">
            <span className="text-lg font-medium text-gray-700">
              {t("dashboard.payment.totalLabel")}
            </span>
