...
//     onError: (error) => toast.error(error, 'Dropzone'),
//   });
...
export const Upload = () => {
  return (
    <div>
      ...
      >
        <UploadIcon 
          className={`mx-auto h-10 sm:h-12 w-10 sm:w-12 transition-colors duration-300 text-primary-500`}
        />
        <p className="mt-4 text-sm sm:text-base text-gray-600">
            <>
              <span className="hidden sm:inline">Drag & drop files here, or </span>
