        ...
        <div className="p-6 prose prose-indigo max-w-none">
          {isGerman ? (
            ...
            <>
              ...
              <p className='mt-2'>Depending on how you interact with our Platform, we may collect:</p>
              ...
              <p className='mt-2'>Once no longer needed, we securely delete or anonymize your data.</p>

              <h3 className="mt-6 font-semibold text-xl ">7. Your Rights (EU Data Subjects)</h3>
              <p className='mt-2'>If you are in the EU/EEA, you have the following rights under the GDPR:</p>
              <ul className="list-disc ml-6">
              ...
              <p className='mt-2'>We use cookies (small text files stored on your device) and similar technologies to:</p>
              <ul className="list-disc ml-6">
